...
FROM core AS hybrid_node

WORKDIR /app/validator/hybrid_node

COPY validator/hybrid_node/requirements.txt .
...
ENV PYTHONPATH="${PYTHONPATH}:/app/validator/hybrid_node/src"
